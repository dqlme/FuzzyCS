...
# data_dir = './dataset/FederatedEMNIST/datasets/'
...
def get_dataloader(data_dir, train_bs, test_bs, client_idx=None):
    ...
    train_h5.close()
    test_h5.close()
    return train_dl, test_dl, num_class
...
def load_partition_data_distributed_federated_emnist(
    ...
    if process_id == 0:
        ...
        train_data_global, test_data_global = get_dataloader(
            data_dir, batch_size, batch_size, process_id - 1
        )
...
def load_partition_data_federated_emnist(
    ...
    for client_idx in range(DEFAULT_TRAIN_CLIENTS_NUM):
        train_data_local, test_data_local, num_class = get_dataloader(
        ...
        num_class_dict[client_idx] = num_class
    # global dataset
